...
impl ImageReader {
    ...
    ///
    /// Instead of passing an [`ImageFormat`] parameter, this constructor accepts the combination of
    /// [`hardwareBufferFormat`] and [`DataSpace`] for the format of the Image that the reader will
    /// produce.
    #[cfg(feature = "api-level-34")]
